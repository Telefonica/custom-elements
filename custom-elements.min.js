...
function D(b,a,c){c=void 0===c?{}:c;var d=c.v||new Set,e=c.i||function(a){return B(b,a)},f=[],g=0;t(a,function(a){if("link"===a.localName&&"import"===a.getAttribute("rel")){var c=a.import;c instanceof Node&&(c.__CE_isImportDocument=!0,c.__CE_hasRegistry=!0);c&&"complete"===c.readyState?c.__CE_documentLoadHandled=!0:a.addEventListener("load",function(){var c=a.import;if(!c.__CE_documentLoadHandled){c.__CE_documentLoadHandled=!0;var f=new Set(d);f.delete(c);D(b,c,{v:f,i:e})}})}else f[g++]=a},d);if(b.b)for(a=
...
b,a);this.g[this.s++]=a;this.b||(this.b=!0,this.f(function(){return fa(c)}))};H.prototype.i=function(b){D(this.a,b)};
...
H.prototype.m=function(b){if(!k(b))return Promise.reject(new SyntaxError("'"+b+"' is not a valid custom element name."));var a=this.j.get(b);if(a)return a.c;a=new ea;this.j.set(b,a);this.a.a.get(b)&&!this.g.some(function(a){return a.localName===b})&&G(a);return a.c};H.prototype.u=function(b){F(this.o);var a=this.f;this.f=function(c){return b(function(){return a(c)})}};window.CustomElementRegistry=H;H.prototype.define=H.prototype.l;H.prototype.upgrade=H.prototype.i;H.prototype.get=H.prototype.get;
H.prototype.whenDefined=H.prototype.m;H.prototype.polyfillWrapFlushCallback=H.prototype.u;var I=window.Document.prototype.createElement,J=window.Document.prototype.createElementNS,ha=window.Document.prototype.importNode,ia=window.Document.prototype.prepend,ja=window.Document.prototype.append,ka=window.DocumentFragment.prototype.prepend,la=window.DocumentFragment.prototype.append,K=window.Node.prototype.cloneNode,L=window.Node.prototype.appendChild,M=window.Node.prototype.insertBefore,N=window.Node.prototype.removeChild,O=window.Node.prototype.replaceChild;
